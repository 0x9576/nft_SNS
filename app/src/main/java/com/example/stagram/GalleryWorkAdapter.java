...
public class GalleryWorkAdapter extends RecyclerView.Adapter<WorkHolder> {
    ...
    GalleryWorkAdapter(ArrayList<PostingItem> data){
        this.dataList = data;
    }
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(pos!= RecyclerView.NO_POSITION){
                    Intent emptyIntent = new Intent(view.getContext().getApplicationContext(), WorkInfoActivity.class);
                    ...
                    //emptyIntent.putExtra("img", postImage.getImage);
