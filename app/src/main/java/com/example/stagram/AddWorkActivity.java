...
public class AddWorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstances) {
        ...
        nftImageView = findViewById(R.id.NFTImageView2);
            ...
            public void onClick(View view) {
                ...
                ref.child("NormalPost").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(AddWorkActivity.this, "자신이 소유한 NFT가 아닙니다.", Toast.LENGTH_SHORT).show();
                    }
        ...
        ticketBuyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(tokenNumber==null)
                {
                    Toast.makeText(AddWorkActivity.this, "추가할 NFT를 선택해주세요.", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    DatabaseReference userRef = ref.child("Gallery").child(galleryContractAddress);
                    userRef.child(tokenNumber).setValue(tokenNumber);
                    Toast.makeText(AddWorkActivity.this, "갤러리에 NFT 추가 완료!", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
