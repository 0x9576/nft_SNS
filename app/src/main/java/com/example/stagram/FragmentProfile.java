...
public class FragmentProfile extends Fragment {
    ...
    ArrayList<FollowerItem> followerList = new ArrayList<>();
    ...
    HashMap<String, String> addressNickname = new HashMap<>();

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Bundle bundle = getArguments();  //踰덈뱾 諛쏄린. getArguments() 硫붿냼�뱶濡� 諛쏆쓬.
        if (bundle != null) {
            privateKey = bundle.getString("privateKey");
            address = bundle.getString("address");
            followerAdapter.setAddress(address);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        img = layout.findViewById(R.id.profileImage);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if (address.equals(member.getAddress())){
                        imgString = member.getImg();
                    }
                }
                nickname = addressNickname.get(address);
                if (nickname == null){
                    nickname = address;
                }
                TextView userAddressTextView =  layout.findViewById(R.id.userAddress);
                userAddressTextView.setText(nickname+"님\n환영합니다.");

                ImageFile imageFile = new ImageFile();
                Bitmap bitmap = imageFile.hexStringToBitmap(imgString);
        ...
        //View layout = inflater.inflate(R.layout.fragment_profile, container, false);
        FloatingActionButton fab_follower = layout.findViewById(R.id.fbt_Follower);
        RecyclerView recyclerView = layout.findViewById(R.id.followerRecyclerView);
        //TextView userAddressTextView =  layout.findViewById(R.id.userAddress);
        TextView balanceKlayTextView =  layout.findViewById(R.id.balanceKlayTextView);
        TextView balanceTokenTextView =  layout.findViewById(R.id.balanceTokenTextView);
        Button profileButton = layout.findViewById(R.id.profileButton);
        //userAddressTextView.setText(nickname+"�떂\n諛섍컩�뒿�땲�떎.");
        try {
            balanceKlayTextView.setText("Klay 잔액: "+blockchain.getBalance(address)+"(KLAY)");
            balanceTokenTextView.setText("NFC 잔액: "+blockchain.getBalanceToken(address)+"(NFC)");
        ...
        fab_follower.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //mData = FirebaseDatabase.getInstance().getReference();//////////
                Intent postIntent = new Intent(getContext(), FollowAddActivity.class);
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String imageString = imageFile.bitmapToByteString(bitmap);
                ref.child("member").child(address).child("img").setValue(imageString);
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot data : snapshot.getChildren()) {
                    ...
                    if (followerItem.getFollower().equals(address)){
                        ...
                        hashMap.put(address+followerItem.getFollow(), data.getKey());
                    }
                }
                followerAdapter.addressKeyMap = hashMap;
